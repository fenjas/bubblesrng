...
public class GUI extends JFrame{
	...
	final int hp1=20,hp2=1,hp3=13,hp4=1,hp5=25,hp6=12; //Hough transform default settings
	...
	int imgCaptureDelay=100; 						   //Wait time between each image capture (ms)
	...
	public GUI() {
		...
		final JButton btnSingleGrab = new JButton("Unigrab");
		final JButton btnDetectBubbles = new JButton("Analyse");		
		final JButton btnClearAll = new JButton("Clear");
		final JButton btnLoadImage = new JButton("Load");
		final JButton btnMultiGrab = new JButton("Multigrab");
		...
		btnHoughApply.setBounds(21, 109, 78, 28);
		btnWSpacePathApply.setBounds(324, 20, 78, 28);
		btnSingleGrab.setBounds(10, 60, 78, 28);
		btnDetectBubbles.setBounds(170, 60, 78, 28);
		btnHoughDefaults.setBounds(97, 109, 78, 28);
		btnClearAll.setBounds(10, 100, 78, 28);
		btnLoadImage.setBounds(90, 60, 78, 28);
		btnMultiGrab.setBounds(10, 20, 78, 28);
		btnExport.setBounds(118, 284, 78, 28);
		btnStop.setBounds(90, 100, 78, 28);
		...
		spinnerMaxRad.setModel(new SpinnerNumberModel(13, 1, 300, 1));
		...
		spinnerBytes.setFont(new Font("SansSerif", Font.PLAIN, 12));
		...
		spinnerBytes.setBounds(90, 20, 158, 28);
		...
		scrollPaneStatus.setBounds(56, 60, 346, 75);
		...
		lblWorkSpace.setBounds(11, 20, 42, 28);
		...
		lblBubbles.setBounds(13, 23, 87, 28);
		lblBubbles.setFont(new Font("Tahoma", Font.PLAIN, 12));
		panelData.add(lblBubbles);

		JLabel lblRndData = new JLabel("S=f(x,y)");
		lblRndData.setForeground(Color.DARK_GRAY);
		lblRndData.setAutoscrolls(true);
		lblRndData.setBounds(15, 115, 73, 15);
		lblRndData.setFont(new Font("Tahoma", Font.PLAIN, 12));
		panelData.add(lblRndData);

		JLabel lblRandomNumbersList = new JLabel("Rnd(S)");
		lblRandomNumbersList.setForeground(Color.DARK_GRAY);
		lblRandomNumbersList.setBounds(120, 115, 73, 15);
		lblRandomNumbersList.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		lblArithmeticMean.setBounds(13, 86, 100, 15);
		...
		lblSerialCorrelation.setBounds(14, 187, 100, 15);
		...
		txtBubbles.setBounds(118, 23, 93, 28);
		...
		txtArithMean.setBounds(118, 79, 93, 28);
		...
		txtTotalBubbles.setBounds(118, 51, 93, 28);
		...
		txtFileBytes.setBounds(115, 30, 99, 28);
		...
		txtEntropy.setBounds(115, 60, 99, 28);
		...
		txtChiSquare.setBounds(115, 90, 99, 28);
		...
		txtMean.setBounds(115, 120, 99, 28);
		...
		txtMonteCarlo.setToolTipText("Given the probability, P, that an event will occur in certain conditions, the number of times" +
		" the event occurs divided by the number of times the conditions are generated should be approximately equal to P");
		txtMonteCarlo.setBounds(115, 150, 99, 28);
		...
		txtSerialCorrelation.setBounds(115, 180, 99, 28);
		...
		panelWorkSpace.setBorder(new TitledBorder(null, "Workspace / Status", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		panelWorkSpace.setBounds(627, 616, 422, 150);
		panelWorkSpace.setLayout(null);
		panelWebCam.setBorder(new TitledBorder(null, "Image Pane", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		panelWebCam.setBounds(10, 10, 810, 606);
		panelHoughTransform.setToolTipText("Hough Transform Parameters");
		panelHoughTransform.setBorder(new TitledBorder(null, "Hough Transform Parameters", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		panelHoughTransform.setBounds(276, 616, 345, 150);
		panelHoughTransform.setLayout(null);
		panelHoughTransform.setFont(new Font("Tahoma", Font.PLAIN, 11));
		panelCommands.setBorder(new TitledBorder(null, "Actions", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		panelCommands.setBounds(10, 616, 260, 150);
		panelCommands.setLayout(null);
		panelCommands.add(btnStop);
		panelData.setBorder(new TitledBorder(null, "Data Pane", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		panelData.setBounds(826, 10, 223, 359);
		panelData.setLayout(null);
		panelENT.setBounds(826, 369, 222, 247);
		panelENT.setBorder(new TitledBorder(null, "ENT Analysis Results", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(64, 64, 64)));
		...
		cbshowCtrData.setBounds(87, 112, 18, 18);
		cbshowRndData.setBounds(193, 112, 18, 18);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ent.exists() && !ent.isDirectory() && !rndDataFn.isEmpty())
				{
					try {
						...
						//Allow 1 sec for the file to be flushed to disk
						Thread.sleep(1000);
		...
		class analyseImage{
			...
			public void go(String fn) throws Exception{
				...
				if (GrabbedFile.exists())
				{
					...
					icon = new ImageIcon(workspacePath+procimageFN);
					lblwebcam.setIcon(icon);
					panelWebCam.revalidate();
					panelWebCam.repaint();
					icon.getImage().flush();
		...
		//Continuous image capture class
		class multiGrab implements Runnable{  
			...
			public void run() {
				...
				/*Start grabbing images ...
				  Stop if bytes captured so far match value set by user
				  Stop if user presses Stop button */	
				while (totalNumofBubbles<bytesToCapture && !halt)
				{ 
					camProc.grabFrame();
					...
					//Null objects and garbage collect
					camProc.nullAll();
					imgProc.nullAll();
					ai.nullAll();
					//Invoke garbage collector after every 50 pics taken
					if (i % 50 == 0) System.gc();
				}
				...
				btnEntAnalysis.setEnabled(true);
		...
		btnMultiGrab.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (camProc.isCameraPresent()){	
					...
					btnEntAnalysis.setEnabled(false);
